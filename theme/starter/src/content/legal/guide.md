...
1. Create a markdown file in `src/content/legal/` (e.g., `src/content/legal/disclaimer.md`).
...
3. Update your `freelance-persona.config.ts`:
    ...
    legal: {
      // ...
      disclaimer: "disclaimer" // The ID of the file in src/content/legal/
    }
    ```
